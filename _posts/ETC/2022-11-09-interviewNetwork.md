...
- TCP 4 way handshake는 TCP연결을 해제하는 단계입니다. 클라이언트는 서버에게 연결해제를 통지하고 서버가 이를 확인하고 클라이언트에게 이를 받았음을 전송하고 최종적으로 연겷이 해제됩니다. 
...
- OSI7 계층은 네트워크 통신을 구성하는 요소들을 7개의 계층으로 표준화한 것입니다. 통신이 일어나는 과정을 단꼐별로 파악할 수 있다는 장점이 있습니다.
