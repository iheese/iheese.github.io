---
layout: post
title: '기계학습_선형회귀 모델, 경사하강법'
subtitle: '6-2주차_배치 경사 하강법(Batch gradient descent), 확률적 경사 하강범(Stochastic Gradient Descent), 미니배치 경사 하강법(Mini-batch gradient descent)'
